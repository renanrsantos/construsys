...
(function ($, undefined) {
    ...
    $.fn.gantt = function (options) {
        ...
        var core = {
            ...
            // Normalizes for old brow-gsers (NOTE: doesn't work when element is outside viewport)
            //TODO: https://github.com/taitems/jQuery.Gantt/issues/137
            elementFromPoint: (function(){ // IIFE
                // version for normal brow-gsers
            ...
            // Here we calculate the number of row-gs, pages and visible start
            ...
            dataPanel: function (element, width) {
                ...
                dataPanel.click(function (e) {
                    ...
                    */
                    ...
                    // Find row-g where click occurred
                    ...
                    // and the id if the clicked object is a row-g
            ...
            rightPanel: function (element, leftPanel /* <- never used? */) {
                ...
                // reused variables
                var $row = $('<div class="row-g header"></div>');
                var i, len;
                ...
                case "hours":
                    ...
                    for (i = 0, len = range.length; i < len; i++) {
                        ...
                        if (rfy !== year) {
                            yearArr.push(
                                '<div class="row-g year" style="width: ' +
                        ...
                        if (rm !== month) {
                            monthArr.push(
                                '<div class="row-g month" style="width: ' +
                ...
                case 'months':
                    ...
                    for (i = 0, len = range.length; i < len; i++) {
                        ...
                        scaleUnitsThisYear++;
                        monthArr.push(
                            '<div class="row-g day wd" id="dh-' + tools.genId(rday) +
                            '" data-offset="' + i * tools.getCellSize() +
                            '" data-repdate="' + rday.getRepDate(settings.scale) + '">' +
                            (1 + rday.getMonth()) + '</div>');
                    }
            ...
            navigation: function (element) {
                ...
                if (settings.navigate === "scroll") {
                    ganttNavigate = $('<div class="navigate-g" />')
                        .append($('<div class="nav-slider" />')
                            .append($('<div class="nav-slider-left" />')
                                .append($('<button type="button" class="nav-link-g nav-page-back"/>')
                                    .html('&uarr;')
                                    .click(function () {
                                ...
                                .append($('<button type="button" class="nav-link-g nav-page-next"/>')
                                    .html('&darr;')
                                    .click(function () {
                                        core.navigatePage(element, 1);
                                    }))
                                .append($('<button type="button" class="nav-link-g nav-now"/>')
                                    .html('&#9679;')
                                    .click(function () {
                                        core.navigateTo(element, 'now');
                                    }))
                                .append($('<button type="button" class="nav-link-g nav-prev-week"/>')
                                    .html('&lt;&lt;')
                                    .click(function () {
                                ...
                                .append($('<button type="button" class="nav-link-g nav-prev-day"/>')
                                    .html('&lt;')
                                    .click(function () {
                                        if (settings.scale === 'hours') {
                            ...
                            .append($('<div class="nav-slider-right" />')
                                .append($('<button type="button" class="nav-link-g nav-next-day"/>')
                                    .html('&gt;')
                                    .click(function () {
                                        if (settings.scale === 'hours') {
                                            core.navigateTo(element, tools.getCellSize() * -4);
                            ...
                            .append($('<button type="button" class="nav-link-g nav-next-week"/>')
                                    .html('&gt;&gt;')
                                    .click(function () {
                                        if (settings.scale === 'hours') {
                                            core.navigateTo(element, tools.getCellSize() * -8);
                                ...
                                .append($('<button type="button" class="nav-link-g nav-zoomIn"/>')
                                    .html('&#43;')
                                    .click(function () {
                                        core.zoomInOut(element, -1);
                                    }))
                                .append($('<button type="button" class="nav-link-g nav-zoomOut"/>')
                                    .html('&#45;')
                                    .click(function () {
                                        core.zoomInOut(element, 1);
                                    }))
                ...
                // Button navigation is provided by setting `settings.navigation='buttons'`
                    ...
                    ganttNavigate = $('<div class="navigate-g" />')
                        ...
                        .append($('<button type="button" class="nav-link-g nav-begin"/>')
                            .html('&#124;&lt;')
                            .click(function () {
                        ...
                        .append($('<button type="button" class="nav-link-g nav-end"/>')
                            .html('&gt;&#124;')
                            .click(function () {
            ...
            fillData: function (element, datapanel, leftpanel /* <- never used? */) {
                ...
                // Loop through the values of each data element and set a row-g
                $.each(element.data, function (i, entry) {
                    if (i >= element.pageNum * settings.itemsPerPage &&
                        i < (element.pageNum * settings.itemsPerPage + settings.itemsPerPage)) {
            ...
            wheelScroll: function (element, e) {
                ...
                // simpler normalization, ignoring per-device/brow-gser/platform acceleration & semantic variations
        ...
        var tools = {
            ...
            getCellSize: function () {
                if (typeof tools._getCellSize === "undefined") {
                    var measure = $('<div style="display: none; position: absolute;" class="fn-gantt"><div class="row-g"></div></div>');
                    $("body").append(measure);
                    tools._getCellSize = measure.find(".row-g").height();
        ...
        this.each(function () {
            ...
            this.rowsOnLastPage = 0; // How many row-gs on last page
            this.rowsNum = 0;        // Number of total row-gs
