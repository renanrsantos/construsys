            ...
            $.extend(
                {
                    ...
                    maxShownResults: 100,
                    noResultsText: 'Nenhum resultado para "{keyword}"',
     ...
     */
        $this._highlight = function (keyword, text) {
            return text.replace(
                ...
                '<span class="highlight"><font color="red">$&</font></span>'
            );
        }
        ...
        $this._item = function (item) {
            ...
            for (var index = 0; index < visibleProperties.length; index++) {
                ...
                if (visibleProperty === 'thumb') {
                    ...
                    var aux = "";
                    if('{'+visibleProperty+'}' !== _options.textProperty){
                        aux='style="font-size:11px;"';
                    }
                    $item = $('<span '+aux+'>')
                        .addClass('item item-' + visibleProperty)
                        .html(propertyText + '&nbsp;&nbsp;&nbsp;');
     ...
     */
        $this._position = function () {
            ...
            $('ul.flexdatalist-results').css({
                ...
                // 'z-index': ($target.css('z-index') + 1) não funciona dentro de input-group
                'z-index': ('auto'+1)
            });
        }
        // Initialize
